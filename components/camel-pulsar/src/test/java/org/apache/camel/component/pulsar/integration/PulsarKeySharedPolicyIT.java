...
public class PulsarKeySharedPolicyIT extends PulsarITSupport {

    private static final Logger LOGGER = LoggerFactory.getLogger(PulsarKeySharedPolicyIT.class);
    ...
    @EndpointInject("pulsar:" + TOPIC_URI + "?numberOfConsumers=" + NUMBER_OF_CONSUMERS + "&subscriptionType=KeyShared"
                    + "&subscriptionName=camel-subscription&consumerQueueSize=1&consumerNamePrefix=camel-consumer1&keySharedPolicy=autoSplitHashRange")
    ...
    @Test
    public void testKeySharedAutoPolicy() throws Exception {
        ...
        for (int i = 0; i < NUMBER_OF_MESSAGES; i++) {
            producer.newMessage().key(String.valueOf(i)).value("Hello").send();
        }
